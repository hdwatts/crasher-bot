...
class Bot {
    ...
    static isAdmin(user_id, onSuccess) {
        this.constructor.getMembers(members=>{
    ...
    static checkMessage(message) {
        ...
        if (messageText && /^\/sail.*/.test(messageText)) {
            this.constructor.isAdmin(message.user_id, this.constructor.sailWithoutHim)
            return null;
        }
        ...
        if (mention && mention[0]) {
            ...
            if (id) {
                ...
                request({
                    ...
                    sendMessage("We sail without him!");
                })
            }
        }
    };
